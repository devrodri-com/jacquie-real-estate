...
export default function Footer() {
  ...
  return (
    <footer className="focus-on-brand mt-16 bg-brand text-on-brand">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:py-12">
        <div className="grid gap-9 md:grid-cols-[1.2fr_1fr_0.85fr] md:gap-10">
          <div>
            <Link
              href={`/${locale}`}
              className="font-display text-[28px] font-medium text-on-brand no-underline hover:opacity-90"
            >
              Jacquie Zárate
            </Link>
            <p className="mt-3 max-w-[42ch] text-[15px] leading-[1.7] text-on-brand">
              {copy.role}
            </p>
            <div className="mt-5 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-on-brand">Jacquie Zárate</p>
                <p className="mt-0.5 text-xs text-on-brand">REALTOR® Associate</p>
              </div>
            </div>
          </div>

          <div>
            <h2 className="text-xs font-semibold uppercase tracking-[0.16em] text-on-brand">
              {copy.contactHeading}
            </h2>
            <a
              ...
              className="mt-4 inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-paper px-4 text-sm font-semibold text-brand no-underline transition-colors hover:bg-brand-subtle"
            >
            ...
            <div className="mt-4 space-y-2.5 text-sm">
              <a
                ...
                className="flex items-center gap-2 text-on-brand no-underline hover:text-on-brand"
              >
              ...
              <Link
                ...
                className="inline-flex text-on-brand underline decoration-on-brand/30 underline-offset-4 hover:text-on-brand"
              >
                {copy.contact}
              </Link>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <Link href={`/${locale}/proyectos`} className="text-on-brand hover:text-on-brand">
                  {copy.projects}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/listings`} className="text-on-brand hover:text-on-brand">
                  {copy.properties}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/financiacion`} className="text-on-brand hover:text-on-brand">
                  {copy.financing}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/sobre-mi`} className="text-on-brand hover:text-on-brand">
                  {copy.about}
                </Link>
              </li>
            </ul>
            <div className="mt-5 border-t border-paper/15 pt-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-on-brand">
                {copy.staysLabel}
              </p>
              <Link
                href={`/${locale}/lets-go-miami`}
                className="mt-2 inline-flex text-sm text-on-brand underline decoration-on-brand/25 underline-offset-4 hover:text-on-brand"
              >
                {copy.stays}
              </Link>
            </div>
        ...
        <div className="mt-9 flex flex-col gap-4 border-t border-paper/12 pt-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-on-brand">
              {copy.brokerage}
            </p>
            <p className="mt-1 text-xs leading-5 text-on-brand">
        ...
        <div className="mt-5 flex flex-col gap-3 border-t border-paper/10 pt-4 text-center text-xs text-on-brand sm:flex-row sm:items-center sm:justify-between sm:text-left">
          <p>
