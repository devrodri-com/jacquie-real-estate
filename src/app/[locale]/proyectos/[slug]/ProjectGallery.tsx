...
export default function ProjectGallery({
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-[119] bg-[#0a1014]/95 backdrop-blur-sm motion-safe:data-[state=closed]:animate-out motion-safe:data-[state=open]:animate-in" />
        <Dialog.Content
