...
const CREDIBILITY_STYLES =
  ".home-cred-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.home-cred-item{display:flex;min-height:96px;align-items:center;gap:.75rem;padding:1rem .75rem;border-color:#3b274a26;color:#3b274ad1;font-size:14px;font-weight:500;line-height:1.45}.home-cred-item:nth-child(even){border-left:1px solid #3b274a26}.home-cred-item:nth-child(n+3){border-top:1px solid #3b274a26}.home-cred-item svg{width:17px;height:17px;flex:none}.home-cred-item span{max-width:24ch}@media(min-width:640px){.home-cred-item{min-height:100px;padding-right:1.25rem;padding-left:1.25rem}}@media(min-width:1024px){.home-cred-list{grid-template-columns:repeat(4,minmax(0,1fr))}.home-cred-item{min-height:108px;padding:1.25rem 1.75rem;border-top-width:0;border-left:1px solid #3b274a26}.home-cred-item:first-child{border-left-width:0}}";
